...
namespace TpServeur1.Controllers
{
    public class ProduitController : Controller
    {
        ...
        {
            var tpContext = _context.Produits.Include(p => p.Categorie);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Description,Marque,Taille,QteInventaire,CategorieId")] Produit produit)
        {
            if (id != produit.Id)
            {
                return NotFound();
